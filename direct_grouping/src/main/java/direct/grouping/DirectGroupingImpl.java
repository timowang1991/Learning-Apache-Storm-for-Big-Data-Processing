...
public class DirectGroupingImpl {
    public static void main(String[] args) throws Exception {
        ...
        builder.setSpout("Emit_Number", new DirectGroupingSpoutExample());
        ...
        builder.setBolt("File_Write_Bolt", new FileWriterBolt(), 3)
            .directGrouping("Emit_Number");

        Config config = new Config();
        config.setDebug(true);
        config.put("dirToWriter", "direct_grouping/data_output/shuffle_output");
